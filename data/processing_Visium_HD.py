...
def run_visium_hd_preprocessing(config):

    params = config['preprocessing']['visium_hd']
    
    process_visium_HD(
        data_dir=config['global']['directory'],
        sample_subfolder=params['sample_size'],
        raw_image_name=params['raw_image_name'],
        output_image_name=params['output_image_name'],
        gene_names_name=params['gene_names_name'],
        ground_truth_name=params['ground_truth'],
        scale_pix_size=params['scale_pix_size'],
        superpixel_size=config['global']['superpixel_size'],
        num_top_genes=params['num_top_genes'],
        pseudo_radius=config['global']['pseudo_radius']
    )